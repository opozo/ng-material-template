...
goog.defineClass.applyProperties_=function(a,b){for(var c in b)Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c]);for(var d=0;d<goog.defineClass.OBJECT_PROTOTYPE_FIELDS_.length;d++)c=goog.defineClass.OBJECT_PROTOTYPE_FIELDS_[d],Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c])};goog.tagUnsealableClass=function(a){!COMPILED&&goog.defineClass.SEAL_CLASS_INSTANCES&&(a.prototype[goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_]=!0)};goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_="goog_defineClass_legacy_unsealable";var ngmaterial={controller:{}};ngmaterial.controller.AppCtrl=function(a){this.mdSidenav_=a;this.start_()};goog.exportSymbol("ngmaterial.controller.AppCtrl",ngmaterial.controller.AppCtrl);ngmaterial.controller.AppCtrl.$inject=["$mdSidenav"];
ngmaterial.controller.AppCtrl.prototype.start_=function(){var a=window.location.pathname.split("/")[1];if(a)switch(a){case "home":case "dashboard":$("#home").removeClass("active");this.selectedItem_=$("#"+a);break;default:this.selectedItem_=$("#home")}else this.selectedItem_=$("#home");this.selectedItem_.addClass("active")};ngmaterial.controller.AppCtrl.prototype.toggleSidenav=function(){this.mdSidenav_("left").toggle()};
goog.exportProperty(ngmaterial.controller.AppCtrl.prototype,"toggleSidenav",ngmaterial.controller.AppCtrl.prototype.toggleSidenav);ngmaterial.controller.AppCtrl.prototype.closeSidenav=function(){this.mdSidenav_("left").close()};goog.exportProperty(ngmaterial.controller.AppCtrl.prototype,"closeSidenav",ngmaterial.controller.AppCtrl.prototype.closeSidenav);
ngmaterial.controller.AppCtrl.prototype.selectItem=function(a){switch(a.target.tagName.toLowerCase()){case "ng-md-icon":case "div":case "md-item-content":case "svg":case "path":a=$(a.target).closest("a");break;default:a=$(a.target)}this.selectedItem_.removeClass("active");a.addClass("active");this.selectedItem_=a;this.closeSidenav()};goog.exportProperty(ngmaterial.controller.AppCtrl.prototype,"selectItem",ngmaterial.controller.AppCtrl.prototype.selectItem);ngmaterial.controller.DashboardCtrl=function(){};goog.exportSymbol("ngmaterial.controller.DashboardCtrl",ngmaterial.controller.DashboardCtrl);ngmaterial.controller.HomeCtrl=function(){this.myUser={firstName:"Orlando",lastName:"Pozo"};this.greeting_="Bonjour"};goog.exportSymbol("ngmaterial.controller.HomeCtrl",ngmaterial.controller.HomeCtrl);ngmaterial.controller.HomeCtrl.prototype.sayHello=function(){return this.greeting_+" "+this.myUser.firstName+" "+this.myUser.lastName};goog.exportProperty(ngmaterial.controller.HomeCtrl.prototype,"sayHello",ngmaterial.controller.HomeCtrl.prototype.sayHello);ngmaterial.ng=angular.module("ngmaterial.ng",[]).run(["$templateCache",function(a){a.put("/ng/dashboard.ng",'<div id="dashboard-view">Dashboard</div>');a.put("/ng/home.ng",'<div id="home-view"><p><div layout layout-sm="column"><md-input-container flex class="md-default-theme" autofocus><label for="first-name">First Name</label><input ng-model="homeCtrl.myUser.firstName" class="ng-pristine ng-untouched ng-valid md-input" tabindex="0" id="first-name" aria-invalid="false"><div class="md-placeholder">Please input your first name</div></md-input-container><md-input-container flex class="md-default-theme"><label for="last-name">Last Name</label><input ng-model="homeCtrl.myUser.lastName" class="ng-pristine ng-untouched ng-valid md-input" tabindex="0" id="last-name" aria-invalid="false"><div class="md-placeholder">Please input your last name</div></md-input-container></div><div><h2 data-ng-class="homeCtrl.myColor">{{homeCtrl.sayHello() | uppercase}}</h2></div></p></div>')}]);ngmaterial.routes=function(a,b){b.html5Mode(!0);a.when("/",{templateUrl:"/ng/home.ng",controller:"HomeCtrl",controllerAs:"homeCtrl"}).when("/dashboard",{templateUrl:"/ng/dashboard.ng",controller:"DashboardCtrl",controllerAs:"dashboardCtrl"}).otherwise({redirectTo:"/"})};ngmaterial.routes.$inject=["$routeProvider","$locationProvider"];
ngmaterial.themes=function(a,b){var c=a.extendPalette("light-blue",{contrastDefaultColor:"light",contrastDarkColors:["50"],50:"ffffff"});a.definePalette("customBlue",c);a.theme("default").primaryPalette("customBlue",{"default":"500","hue-1":"50"}).accentPalette("red");a.theme("input","default").primaryPalette("grey");b.defaultIconSet("/img/avatars.svg",128)};ngmaterial.themes.$inject=["$mdThemingProvider","$mdIconProvider"];
ngmaterial.module=angular.module("BoilerplateApp",[ngmaterial.ng.name,"ngRoute","ngMaterial","ngMdIcons"]);ngmaterial.module.config(ngmaterial.routes);ngmaterial.module.config(ngmaterial.themes);ngmaterial.module.controller("AppCtrl",ngmaterial.controller.AppCtrl);ngmaterial.module.controller("HomeCtrl",ngmaterial.controller.HomeCtrl);ngmaterial.module.controller("DashboardCtrl",ngmaterial.controller.DashboardCtrl);
//# sourceMappingURL=/js/min/bundle.min.map